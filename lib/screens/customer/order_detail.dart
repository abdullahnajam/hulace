...
class OrderDetail extends StatefulWidget {
  OrderModel order;String type;

  OrderDetail(this.order,this.type);
                ...
                child: ListView(
                  ...
                  children: [
                    FutureBuilder<UserModel>(
                        future: getUserData(widget.type=="Vendor"?widget.order.customerId:widget.order.vendorId),
                          ...
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            if (snapshot.hasError) {
                              ...
                              return ListTile(
                                ...
                                trailing: InkWell(
                                  onTap: ()async{
                                    await FirebaseFirestore.instance.collection('chat_head').doc("${widget.order.customerId}-${widget.order.vendorId}").set({
