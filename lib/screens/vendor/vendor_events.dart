...
class VendorEvents extends StatefulWidget {
  const VendorEvents({Key? key}) : super(key: key);

  @override
  _VendorEventsState createState() => _VendorEventsState();
}

class _VendorEventsState extends State<VendorEvents> {
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance.collection('events').where("services",arrayContains: provider.userData!.businessCategory).snapshots(),
